...
\geometry{verbose,tmargin=3cm,bmargin=3cm,lmargin=3.5cm,rmargin=2.5cm,headheight=3cm,headsep=3cm,footskip=1.5cm}
...
with $\N_{\mu,\sigma}\left(\RR\right)=1$. If $\X\in\N\left(\mu,\sigma\right)$
then it is a simple exercise to prove that $\frac{\X-\mu}{\sigma}\in\N\left(0,1\right)$.
...
we have $\E\X=\sum_{\i}\E\one_{\A_{\i}}=\sum_{\i}\Pr\A_{\i}$.
\end{rem}
...
for all $\sigma\left(\X_{2}\right)$-measurable integerable random
