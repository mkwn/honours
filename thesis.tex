...
that $\E\left[\one_{\A_{1}}\E\left[\X_{1}|\X_{2}\right]\one_{\A_{2}}\right]=\E\left[\one_{\A_{1}}\X_{1}\one_{\A_{2}}\right]$
for all $\A_{1},\A_{2}\in\sigma\left(\X_{2}\right)$. That is, $\one_{\A_{1}}\E\left[\X_{1}|\X_{2}\right]=\E\left[\X_{1}\one_{\A_{1}}|\X_{2}\right]$.
By linearity and an approximation argument, it follows that $\X_{3}\E\left[\X_{1}|\X_{2}\right]=\E\left[\X_{3}\X_{1}|\X_{2}\right]$
...
we have
\[
\E\left[\E^{\X_{3}}\left[\X_{1}\right]\one_{\A}\right]=\E\left[\X_{1}\one_{\A}\right]=\E\left[\E^{\X_{2}}\left[\X_{1}\right]\one_{\A}\right].
\]
