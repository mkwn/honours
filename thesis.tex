...
\]
Combining these estimates with \ref{eq:short-cycles-increment-bound},
\ref{eq:short-cycles-decrement-bound}, \ref{eq:EXT0-immigration-death-bound},
and \ref{eq:stein-distance-transform}, \ref{thm:short-cycles-variable}
